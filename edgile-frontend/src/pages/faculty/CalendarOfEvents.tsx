...
const FacultyCalendarOfEvents: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCOEs = async () => {
      try {
        ...
        else setError('Failed to load calendars.');
      } catch (e) {
  ...
  return (
    <DashboardWrapper>
      <Box sx={{ p: { xs: 2, md: 4 } }}>
        ...
        {error && (
          <Paper sx={{ p: 4, textAlign: 'center', width: '100%', mb: 2, bgcolor: '#ffeaea', color: 'error.main' }}>
...
export default FacultyCalendarOfEvents; 